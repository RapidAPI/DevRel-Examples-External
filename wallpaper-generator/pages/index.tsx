      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center my-16">
        ...
        <div className="mt-12 flex max-w-xl flex-col flex-wrap sm:w-full border border-gray-300 p-6 rounded-md shadow-sm">
          ...
          <div className="w-full text-left">
            {hexValueInputBox.map((item, index) => (
              <input
                ...
                className="mr-2 my-2 ml-[38px] text-sm rounded-md w-[100px] border border-gray-300 shadow-sm p-2 focus:ring-black"
          ...
          <div className="flex mt-4">
            ...
            <p className="mt-1 ml-2">Please provide the name of your company</p>
          </div>
          <div className="w-full text-left ml-[38px]">
            <input
              className="w-5/6 mt-2 text-sm rounded-md border border-gray-300 shadow-sm p-2 focus:ring-black"
